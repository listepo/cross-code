...
// The UDL scaffolding generated by `uniffi::include_scaffolding!` defines its metadata as a large
// `const` array; clippy 1.98 flags that (`large_const_arrays`) in code we do not own.
