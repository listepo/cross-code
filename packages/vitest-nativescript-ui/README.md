# @cross-code/vitest-nativescript-ui

Optional NativeScript Core results UI for
`@cross-code/vitest-nativescript`. It is a separate package so CI/headless
...
```bash
pnpm add @cross-code/vitest-nativescript-ui @nativescript/core
```
