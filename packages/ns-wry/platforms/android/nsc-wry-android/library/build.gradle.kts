...
android {
    namespace = "org.nativescript.wry"
    compileSdk = 35
...
dependencies {
    // No JavaCPP dependency — native JNI is provided by libwry_jni.so
}

// ---------------------------------------------------------------------------
// Native pipeline: cargo-ndk cross-compiles the wry-jni Rust crate for
// all Android ABIs.
// ---------------------------------------------------------------------------
