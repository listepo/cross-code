...
async function cleanExecutor(options, context) {
    const platformsDir = (0, node_path_1.join)((0, common_1.nsAppRoot)(context), 'platforms');
    if (options.platform) {
    ...
    if (options.all) {
        const nodeModulesDir = (0, node_path_1.join)((0, common_1.nsAppRoot)(context), 'node_modules');
